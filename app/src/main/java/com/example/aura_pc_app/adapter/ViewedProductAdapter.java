...
public class ViewedProductAdapter extends RecyclerView.Adapter<ViewedProductAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_viewed_product, parent, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            image = itemView.findViewById(R.id.viewedProductImage);
            name = itemView.findViewById(R.id.viewedProductName);
            price = itemView.findViewById(R.id.viewedProductPrice);
        }
    }
}
